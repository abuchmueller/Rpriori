...
#'
#' @format An object of class transaction with  15729  itemsets and 936 items. 
#' Session IDs and time stamps for transactions are also provided.
#' @author Michael Hahsler
#' @source http://epub.wu-wien.ac.at
"Epub"