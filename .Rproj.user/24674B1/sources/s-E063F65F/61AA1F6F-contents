...
testthat::test_that("Simple test of DetSupport_row with candidates that have different amount of items and different rows",{
  ...
  testthat::expect_equal(DetSupport_row(cand1, trans), 0.3)
  testthat::expect_equal(DetSupport_row(cand2, trans), 0.8)
  testthat::expect_equal(DetSupport_row(cand3, trans), 0.1)
  testthat::expect_equal(DetSupport_row(cand4, trans), 0.8)
})
